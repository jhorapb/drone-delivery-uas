...
def main():
    ...
    ''' examples '''
    resp = udp_client.interact_with_server('$POS,E7E7E7E7E7,AB,0.3')
    check_for_conflict(database, resp, 'E7E7E7E7E7', 'AB')
    time.sleep(1)
    
    resp = udp_client.interact_with_server('$POS,E7E7E7E7E7,AB,0.5')
    check_for_conflict(database, resp, 'E7E7E7E7E7', 'AB')
    time.sleep(1)
    
    resp = udp_client.interact_with_server('$POS,E7E7E7E7E7,BC1,0.5')
    check_for_conflict(database, resp, 'E7E7E7E7E7', 'BC1')
    time.sleep(1)
    
    resp = udp_client.interact_with_server('$POS,E7E7E7E7E7,BC1,0.3')
    check_for_conflict(database, resp, 'E7E7E7E7E7', 'BC1')
    time.sleep(1)
    
    resp = udp_client.interact_with_server('$POS,E7E7E7E7E7,BC2,0.3')
    check_for_conflict(database, resp, 'E7E7E7E7E7', 'BC2')
    time.sleep(1)
    
    resp = udp_client.interact_with_server('$POS,E7E7E7E7E7,BC3,0.3')
    check_for_conflict(database, resp, 'E7E7E7E7E7', 'BC3')
    time.sleep(1)
    
    resp = udp_client.interact_with_server('$POS,E7E7E7E7E7,C,0.3')
    check_for_conflict(database, resp, 'E7E7E7E7E7', 'C')
